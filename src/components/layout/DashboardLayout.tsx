...
export const SidebarHeader = ({
  ...
  <div
    className={`flex items-center justify-center h-16 px-6 border-b border-gray-200 ${className}`}
  >
    {children}
  </div>
);
    ...
    <SidebarContext.Provider value={{ isOpen, toggleSidebar }}>
      <div className="flex h-screen bg-gray-50 overflow-hidden">
          ...
          <div className="flex flex-col h-full">
            ...
            <SidebarHeader>
              <div className="flex items-center space-x-3">
                <div
                  className={`w-7 h-8 ${currentTheme.bg} rounded-lg flex items-center justify-center`}
                >
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          {/* Page content */}
          <main className="flex-1 overflow-y-auto px-2 py-4 lg:px-6">
            {children}
          </main>
        </div>
      </div>
