...
import type { UserProfile, ProfileFieldsConfigResponse, UpdateBasicInfoRequest, UpdateProfileFieldsRequest } from '@/lib/api/users/types'
...
export function useUpdateBasicInfo() {
  ...
  return useMutation({
    mutationFn: (data: UpdateBasicInfoRequest) => usersApi.updateBasicInfo(data),
