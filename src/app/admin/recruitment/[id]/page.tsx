...
export default function RecruitmentDetailPage() {
  ...
  const currentClub = clubs?.find(
    (club: Club) => club.id === recruitment?.clubId,
  );
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              {recruitment.status === "draft" && (
                <DropdownMenuItem
                  onClick={() =>
                    handleStatusChange(RecruitmentStatus.PUBLISHED)
                  }
                >
              ...
              {(recruitment.status === "published" ||
                recruitment.status === "draft") && (
                <DropdownMenuItem
                  onClick={() => handleStatusChange(RecruitmentStatus.ONGOING)}
                >
                  <Play className="mr-2 h-4 w-4" />
                  开始招新
                </DropdownMenuItem>
              ...
              {recruitment.status !== "finished" &&
                recruitment.status !== "archived" && (
                  <DropdownMenuItem
                    onClick={() =>
                      handleStatusChange(RecruitmentStatus.FINISHED)
                    }
                  >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-2">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <h3 className="font-medium flex items-center">
                  <CalendarIcon className="mr-2 h-4 w-4" /> 开始时间
                </h3>
                <p className="text-gray-600">
                  {recruitment.startTime
                    ? new Date(recruitment.startTime).toLocaleDateString(
                        "zh-CN",
                        {
                          year: "numeric",
                          month: "long",
              ...
              <div>
                <h3 className="font-medium flex items-center">
                  <CalendarIcon className="mr-2 h-4 w-4" /> 结束时间
                </h3>
                <p className="text-gray-600">
                  {recruitment.endTime
            ...
            <div>
              <h3 className="font-medium flex items-center">
                <User className="mr-2 h-4 w-4" /> 管理员
              </h3>
              <p className="text-gray-600">
